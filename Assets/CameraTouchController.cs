...
public class CameraTouchController : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 20)] float filterFector = 1;
    [SerializeField, Range(0, 10)] float dragFector = 1;
    [SerializeField, Range(0, 2)] float zoomFactor = 1;

    [Tooltip("equal camera y")]
    ...
    void Update()
    {
        ...
        if (touch0.phase == TouchPhase.Moved)
        {
            ...
            // menggunakan lerp(Linear Inperpolation) sebagai filter agar
            //movement lebih smooth
            var targetPos = cameraBeganWorldPos - delta * dragFector;

            // var minX = topCollider.bounds.max.
